...
```
sessions_send target=market-analyst message="TASK-XXX: Нужен фундаментальный анализ BTC. Детали на Task Board."
```
...
```
sessions_send target=orchestrator message="Сделка BTCUSDT LONG @ $98,500. Детали в TASK-XXX."
```
